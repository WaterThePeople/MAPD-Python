...
from .constants import (
    ...
    DEFAULT_MAX_SIMULATION_TIME_SECONDS,
...
def serialize_scenario(config: ScenarioConfig, tasks: list[Task]) -> str:
    lines = [
        ...
        f"MaxSimulationTimeSeconds: {config.max_simulation_time_seconds}",
        "",
...
def build_scenario_config(
    ...
    return ScenarioConfig(
        ...
        max_simulation_time_seconds=DEFAULT_MAX_SIMULATION_TIME_SECONDS,
